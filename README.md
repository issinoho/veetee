...
**Status:** early development — 0.8.7: the VT100 through VT525 (colour, VT500 character sets,
...
```sh
sudo apt install ./veetee_0.8.7-1_amd64.deb
```
...
```sh
flatpak install --user ./veetee-0.8.7-x86_64.flatpak
...
For Windows 10 (1809) or later, unzip `veetee-0.8.7-x86_64-windows.zip` and run
