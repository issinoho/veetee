...
```sh
sudo apt install ./veetee_1.0.0-1_amd64.deb          # Debian, Ubuntu
sudo dnf install ./veetee-1.0.0-1.x86_64.rpm         # Fedora, RHEL
sudo zypper install ./veetee-1.0.0-1.x86_64.rpm      # openSUSE
```
...
```sh
flatpak install --user ./veetee-1.0.0-x86_64.flatpak
...
For Windows 10 (1809) or later, unzip `veetee-1.0.0-x86_64-windows.zip` and run
