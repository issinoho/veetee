...
**Status:** early development — 0.8.2: the VT100 through VT525 (colour, VT500 character sets,
...
For Windows 10 (1809) or later, unzip `veetee-0.8.2-x86_64-windows.zip` and run
